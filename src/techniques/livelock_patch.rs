...
use crate::{
    semantics::{semantics::Semantics, labelled_petri_net_semantics::LPNMarking}, 
    techniques::livelock::IsPartOfLivelock, stochastic_semantics::stochastic_semantics::StochasticSemantics};
...
/// detected livelock SCC contains one extra silent transition `tau_timeout` leading to a global sink place.  The rate of that transition is
