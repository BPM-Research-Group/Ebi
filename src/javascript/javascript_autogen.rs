...
mod tests {
	...
	pub fn analyse_all_traces_test_2() {
        let inputs = vec![
			JavascriptInput::from(std::fs::read_to_string("./testfiles/markovian.slang").unwrap())
	...
	pub fn association_all_trace_attributes_test_2() {
        let inputs = vec![
			JavascriptInput::from(std::fs::read_to_string("./testfiles/fig_a.xes").unwrap())
	...
	pub fn convert_stochastic_labelled_petri_net_test_2() {
        let inputs = vec![
			JavascriptInput::from(std::fs::read_to_string("./testfiles/empty_net.slpn").unwrap())
