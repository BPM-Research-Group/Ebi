...
impl EbiObjectType {
    ...
    pub fn get_article(&self) -> &str {
        match self {
            ...
            EbiObjectType::StochasticLanguageOfAlignments => "a",
        }
    }
...
impl Display for EbiObjectType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}", match self {
            ...
            EbiObjectType::StochasticLanguageOfAlignments => "stochastic alignments",
        })
    }
}
...
pub enum EbiObject {
    ...
    StochasticLangaugeofAlignments(StochasticLanguageOfAlignments),
}
...
impl EbiObject {
    pub fn get_type(&self) -> EbiObjectType {
        match self {
            ...
            EbiObject::StochasticLangaugeofAlignments(_) => EbiObjectType::StochasticLanguageOfAlignments,
        }
    }
}
...
impl Display for EbiObject {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            EbiObject::StochasticLangaugeofAlignments(o) => write!(f, "{}", o),
        }
    }
}
...
impl Infoable for EbiObject {
    fn info(&self, f: &mut impl std::io::Write) -> Result<()> {
        match self {
            ...
            EbiObject::StochasticLangaugeofAlignments(o) => o.info(f),
        }
    }
}
