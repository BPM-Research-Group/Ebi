...
pub const EBI_ANALYSE_NON_STOCHASTIC_ALIGNMENT: EbiCommand = EbiCommand::Command {
    ...
    execute: |mut objects, _| {
        ...
        return Ok(EbiOutput::Object(EbiObject::StochasticLangaugeofAlignments(result)));
    }, 
    output: &EbiOutputType::ObjectType(EbiObjectType::StochasticLanguageOfAlignments)
};