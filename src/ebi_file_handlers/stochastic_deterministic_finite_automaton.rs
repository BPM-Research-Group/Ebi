use crate::ebi_framework::{
    ...
    object_importers::{
        ImportAsDeterministicFiniteAutomatonObject, ImportAsLabelledPetriNetObject, ImportAsStochasticLabelledPetriNetObject, ImportAsStochasticNondeterministicFiniteAutomatonObject, TryToBusinessProcessModelAndNotationObject
    },
    trait_importers::{
...
use ebi_objects::{anyhow::{Result, anyhow}, EbiObject, Exportable, Importable, StochasticDeterministicFiniteAutomaton};
...
pub const EBI_STOCHASTIC_DETERMINISTIC_FINITE_AUTOMATON: EbiFileHandler = EbiFileHandler {
    ...
    object_importers: &[
        ...
        EbiObjectImporter::DeterministicFiniteAutomaton(
            StochasticDeterministicFiniteAutomaton::import_as_deterministic_finite_automaton_object, 
            StochasticDeterministicFiniteAutomaton::IMPORTER_PARAMETERS
        ),
    ],
    object_importers_fallible: &[EbiObjectImporterFallible::BusinessProcessModelAndNotation(
            StochasticDeterministicFiniteAutomaton::try_import_as_business_process_model_and_notation_object,
            StochasticDeterministicFiniteAutomaton::IMPORTER_PARAMETERS,
        ),],
    object_exporters: &[
