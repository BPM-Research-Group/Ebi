use crate::ebi_framework::{
    ...
    object_importers::{
        ImportAsBusinessProcessModelAndNotationObject, ImportAsLabelledPetriNetObject, ImportAsProcessTreeObject, ImportAsStochasticNondeterministicFiniteAutomatonObject
    },
    trait_importers::{
