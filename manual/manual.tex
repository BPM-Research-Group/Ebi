...
\label{sec:architecture}
    ...
    \label{sec:objecttypes}
        ...
        Ebi has the following object types; please refer to the \href{https://docs.rs/ebi_objects/0.3.111/ebi_objects/ebi_objects/index.html}{documentation} for more information.
        \ebiobjecttypelist
