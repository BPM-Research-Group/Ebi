...
\end{lstlisting}
    ...
    \label{sec:exact}
        ...
        \subsection{LogPolynomial}
            ...
            The value of any fraction $r \in \mathbb{Q}$ is:
            $$ q = \logpol((q, 2))$$
            ...
            \begin{align*}
                \logpol((\frac{a}{b}, c), (\frac{d}{e}, f)) =& \frac{a \log_2(c)}{b} + \frac{d \log_2(e)}{f}\\
                & \frac{fa \log_2(c)}{bf} + \frac{bd \log_2(e)}{bf}\\
                & \frac{\log_2(c^{fa}) + \log_2(e^{bd})}{bf}\\
                & \frac{\log_2(c^{fa} + e^{bd})}{bf}\\
                & \frac{1}{bf} \log_2(c^{fa} + e^{bd})
            \end{align*}
