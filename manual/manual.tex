...
\label{sec:architecture}
    ...
    \subsection{Files and objects}
        ...
        \subsubsection{File Handlers $\rightarrow$ Objects (importers)}
            \filehandlersobjecttypes

        \subsubsection{File Handlers $\rightarrow$ Traits (importers)}
            \filehandlerstraits

        \subsubsection{Objects $\rightarrow$ file handlers (exporters)}
            ...
            \noindent\objecttypesfilehandlers
