...
\section{Ebi: introduction}
    ...
    \subsection{Python/PM4Py plug-in}
        ...
        We're currently working on automated installation through PyPi.

        To install Ebi in Python manually, first set up Ebi for local development and install Maturin, then generate a .whl file using \verb=maturin build=.
